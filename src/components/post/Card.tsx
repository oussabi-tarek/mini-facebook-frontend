...
export default function Card(props:CardProps){
    return(
<div className={`flex ${props.isProfile ? 'flex-col' : 'flex-col'} items-left w-6/12 h-5/12 mb-6 mt-6 ml-20 mr-20 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700`}>
